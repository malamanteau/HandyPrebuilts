...
typedef int (APIENTRYP PFNGLXGETSWAPINTERVALMESAPROC)();
GLAPI PFNGLXGETSWAPINTERVALMESAPROC glad_glXGetSwapIntervalMESA;
GLAPI PFNGLXGETSWAPINTERVALMESAPROC glad_debug_glXGetSwapIntervalMESA;
...
GLAPI PFNGLXSWAPINTERVALMESAPROC glad_debug_glXSwapIntervalMESA;
